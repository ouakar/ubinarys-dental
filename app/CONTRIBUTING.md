...
Welcome to the [ubinarys-erp-crm](<[ubinarys-erp-crm](https://github.com/ubinarys/ubinarys-erp-crm)>) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/ubinarys/ubinarys-erp-crm/issues).
- make sure it is not work in progress here [pull requests](https://github.com/ubinarys/ubinarys-erp-crm/pulls).
- you can then [create an issue](https://github.com/ubinarys/ubinarys-erp-crm/issues/new/choose) with the following information:
...
Thank you for contributing to [ubinarys-erp-crm](https://github.com/ubinarys/ubinarys-erp-crm) dont forget to give us a :star: !
