# UBINARYS Λογισμικό ERP & CRM ανοιχτού κώδικα

GitHub: [https://github.com/ubinarys/ubinarys-erp-crm](https://github.com/ubinarys/ubinarys-erp-crm)
Επίδειξη: [https://www.ubinarysapp.com/open-source-erp-crm/](https://www.ubinarysapp.com/open-source-erp-crm/)
Ιστοσελίδα: [https://www.ubinarysapp.com](https://www.ubinarysapp.com)

## Στοίβα Λογισμικού

Το UBINARYS είναι μια δωρεάν εφαρμογή ERP & CRM ανοιχτού κώδικα, βασισμένη στο "mern-stack": Node.js React.js Redux Express.js MongoDB AntDesign (AntD)
