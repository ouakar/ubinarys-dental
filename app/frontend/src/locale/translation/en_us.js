const lang = {
  ...
  run_and_scale_your_erp_crm_apps: 'Optimisez la gestion de votre cabinet avec Ubinarys',
  ...
  customer_preview: 'Patient Preview',
  show: 'Show',
  edit: 'Edit',
  download: 'Download',
  draft: 'Draft',
  ...
  accepted: 'Accepted',
  expired: 'Expired',
  new_customer_this_month: 'New Patient This Month',
  active_customer: 'Active Patient',
  overdue: 'Overdue',
  partially: 'Partially',
  paid: 'Paid',
  sign_in: 'Sign In',
  ...
  client_list: 'Patient List',
  add_new_client: 'Add New Patient',
  delete: 'Delete',
  type: 'Type',
  phone: 'Phone',
  refresh: 'Refresh',
  ...
  customer_referral: 'Patient Referral',
  sales: 'Sales',
  other: 'Other',
  add_new: 'Add New',
  date: 'Date',
  ...
  'Branding Mode': 'Branding Mode',
  'Clinic Logo Only': 'Clinic Logo Only',
  'Clinic Name Only': 'Clinic Name Only',
  'Clinic Logo + Name': 'Clinic Logo + Name',
  'Clinic Logo (Optional)': 'Clinic Logo (Optional)',
  'Clinic Branding Output Preview (Client Facing)': 'Clinic Branding Output Preview (Client Facing)',
  'This is how your clinic name/logo will appear across the platform and on documents.': 'This is how your clinic name/logo will appear across the platform and on documents.',
  ...
  'Use a horizontal logo. PNG with transparent background is recommended.': 'Use a horizontal logo. PNG with transparent background is recommended.',
  'Note': 'Note',
  'If your logo is light-colored, make sure it has enough contrast to remain visible on light backgrounds.': 'If your logo is light-colored, make sure it has enough contrast to remain visible on light backgrounds.',
