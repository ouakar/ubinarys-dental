...
import { Avatar, Dropdown, Layout, Badge, Button, Select } from 'antd';
...
export default function HeaderContent() {
  ...
  return (
    ...
    >
      ...
      <Select
        defaultValue={window.localStorage.getItem('app_lang') || 'fr_fr'}
        style={{ width: 130 }}
        onChange={(val) => {
          window.localStorage.setItem('app_lang', val);
