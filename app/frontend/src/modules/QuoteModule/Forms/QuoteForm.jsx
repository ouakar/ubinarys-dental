...
export default function QuoteForm({ subTotal = 0, current = null, form = null }) {
  ...
  return <LoadQuoteForm subTotal={subTotal} current={current} form={form} />;
}

function LoadQuoteForm({ subTotal = 0, current = null, form = null }) {
    ...
    <>
      ...
      <Form.List name="items">
        {(fields, { add, remove }) => (
          <>
            {fields.map((field) => (
              <ItemRow key={field.key} remove={remove} field={field} current={current} form={form}></ItemRow>
            ))}
            <Form.Item>
              <Button
                type="dashed"
