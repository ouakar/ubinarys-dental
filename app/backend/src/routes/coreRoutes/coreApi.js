...
// //_______________________________ User management (for dentists, receptionists etc)_______________________________
router.route('/users/list').get(hasRole(['admin', 'owner']), catchErrors(adminController.list));
router.route('/users/create').post(hasRole(['admin', 'owner']), catchErrors(adminController.create));
router.route('/users/update/:id').patch(hasRole(['admin', 'owner']), catchErrors(adminController.update));
router.route('/users/:id/status').patch(hasRole(['admin', 'owner']), catchErrors(adminController.updateStatus));
