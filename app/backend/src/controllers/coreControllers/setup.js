...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      ubinarys_app_email: email,
      ubinarys_app_company_email: email,
      ubinarys_app_timezone: timezone,
      ubinarys_app_country: country,
      ubinarys_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully UBINARYS App Setup',
  });
};
