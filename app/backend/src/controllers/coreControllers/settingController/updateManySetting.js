...
const updateManySetting = async (req, res) => {
  ...
  for (const setting of settings) {
    ...
    let { settingKey, settingValue } = setting;

    if (settingKey === 'default_vat_rate' && (settingValue === '' || settingValue === null || settingValue === undefined)) {
      settingValue = 0;
    }
    if (settingKey === 'currency' && (settingValue === '' || settingValue === null || settingValue === undefined)) {
      settingValue = 'MAD';
    }
